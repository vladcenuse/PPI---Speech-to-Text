        ...
        <div class="field-container">
          ...
          <div class="input-group">
            <textarea 
              ...
              placeholder="Introduceți sau înregistrați medicamentele prescrise..."
              rows="4"
        ...
        <div class="field-container">
          ...
          <div class="input-group">
            <textarea 
              ...
              placeholder="Introduceți sau înregistrați instrucțiunile de dozaj..."
              rows="3"
              @input="updateField('dosage', $event.target.value)"
              class="form-input"
            ></textarea>
            <span v-if="parsedData && parsedData['dozaj'] && parsedData['dozaj'] !== ''" class="parsed-indicator" title="Valoare extrasă din audio">
              ✓
            </span>
          </div>
        </div>
        ...
        <div class="field-container">
          ...
          <div class="input-group">
            <textarea 
              ...
              placeholder="Introduceți sau înregistrați instrucțiunile speciale..."
              rows="4"
              @input="updateField('instructions', $event.target.value)"
              class="form-input"
            ></textarea>
            <span v-if="parsedData && parsedData['instructiuni'] && parsedData['instructiuni'] !== ''" class="parsed-indicator" title="Valoare extrasă din audio">
              ✓
            </span>
          </div>
        </div>
        ...
        <div class="field-container">
          ...
          <div class="input-group">
            <textarea 
              ...
              placeholder="Introduceți sau înregistrați instrucțiunile de urmărire..."
              rows="3"
...
watch([audioBlob, isRecording], async ([newBlob, recording]) => {
  if (!recording && newBlob && shouldAutoProcess.value) {
    ...
    try {
      await processAudio(fieldList, 'prescription-form', selectedModel.value)
    } catch (err) {
